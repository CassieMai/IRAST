...
parser.add_argument('--dataset_path', type=str, default='/maixiaochun/0_datasets/colorization/')
...
def main():
    ...
    # rand_seed = 123456
    rand_seed = np.random.randint(0,3000,1)[0]
...
def train(train_list_unlabel, train_list_label, model, criterion_mse, criterion_cls, optimizer, epoch):
    ...
    for i, (img, target, flag) in enumerate(train_loader):
        ...
        # print('training time per image: ', (time.time()-end)/img.size()[0])
